  ...
  test "Get tails" do
	...
	test "Compare" do
		assert KTails.compare_all(EFSMTest.efsm1, 1) == %{
																											...
																											{2,3}=>0,{2,4}=>0,{2,5}=>0,{2,6}=>0,{2,7}=>1.51,{2,8}=>2.0,{2,9}=>0,{2,10}=>0,
																											{3,4}=>0,{3,5}=>1.5,{3,6}=>0,{3,7}=>0,{3,8}=>0,{3,9}=>1.01,{3,10}=>0,
																											{4,5}=>0,{4,6}=>0,{4,7}=>0,{4,8}=>0,{4,9}=>0,{4,10}=>0,
																											{5,6}=>0,{5,7}=>0,{5,8}=>0,{5,9}=>1.01,{5,10}=>0,
																											{6,7}=>0,{6,8}=>0,{6,9}=>0,{6,10}=>0,
																											{7,8}=>1.51,{7,9}=>0,{7,10}=>0,
																											{8,9}=>0,{8,10}=>0,
																											{9,10}=>0
																											}
		assert KTails.compare_all(EFSMTest.efsm1, 2) == %{{0,1}=>4.53,{0,2}=>0,{0,3}=>0,{0,4}=>0,{0,5}=>0,{0,6}=>0,{0,7}=>4.53,{0,8}=>0,{0,9}=>0,{0,10}=>0,{1,2}=>4.52,{1,3}=>0,{1,4}=>0,{1,5}=>0,{1,6}=>0,{1,7}=>5.02,{1,8}=>4.03,{1,9}=>0,{1,10}=>0,{2,3}=>0,{2,4}=>0,{2,5}=>0,{2,6}=>0,{2,7}=>1.51,{2,8}=>3.01,{2,9}=>0,{2,10}=>0,{3,4}=>0,{3,5}=>1.5,{3,6}=>0,{3,7}=>0,{3,8}=>0,{3,9}=>1.01,{3,10}=>0,{4,5}=>0,{4,6}=>0,{4,7}=>0,{4,8}=>0,{4,9}=>0,{4,10}=>0,{5,6}=>0,{5,7}=>0,{5,8}=>0,{5,9}=>1.01,{5,10}=>0,{6,7}=>0,{6,8}=>0,{6,9}=>0,{6,10}=>0,{7,8}=>1.51,{7,9}=>0,{7,10}=>0,{8,9}=>0,{8,10}=>0,{9,10}=>0}
		assert KTails.compare_all(EFSMTest.efsm1, 3) == %{{0,1}=>6.029999999999999,{0,2}=>0,{0,3}=>0,{0,4}=>0,{0,5}=>0,{0,6}=>0,{0,7}=>5.54,{0,8}=>0,{0,9}=>0,{0,10}=>0,{1,2}=>4.52,{1,3}=>0,{1,4}=>0,{1,5}=>0,{1,6}=>0,{1,7}=>6.029999999999999,{1,8}=>4.03,{1,9}=>0,{1,10}=>0,{2,3}=>0,{2,4}=>0,{2,5}=>0,{2,6}=>0,{2,7}=>1.51,{2,8}=>3.01,{2,9}=>0,{2,10}=>0,{3,4}=>0,{3,5}=>1.5,{3,6}=>0,{3,7}=>0,{3,8}=>0,{3,9}=>1.01,{3,10}=>0,{4,5}=>0,{4,6}=>0,{4,7}=>0,{4,8}=>0,{4,9}=>0,{4,10}=>0,{5,6}=>0,{5,7}=>0,{5,8}=>0,{5,9}=>1.01,{5,10}=>0,{6,7}=>0,{6,8}=>0,{6,9}=>0,{6,10}=>0,{7,8}=>1.51,{7,9}=>0,{7,10}=>0,{8,9}=>0,{8,10}=>0,{9,10}=>0}
		assert KTails.compare_all(EFSMTest.efsm1, 4) == %{{0,1}=>6.029999999999999,{0,2}=>0,{0,3}=>0,{0,4}=>0,{0,5}=>0,{0,6}=>0,{0,7}=>5.54,{0,8}=>0,{0,9}=>0,{0,10}=>0,{1,2}=>4.52,{1,3}=>0,{1,4}=>0,{1,5}=>0,{1,6}=>0,{1,7}=>6.029999999999999,{1,8}=>4.03,{1,9}=>0,{1,10}=>0,{2,3}=>0,{2,4}=>0,{2,5}=>0,{2,6}=>0,{2,7}=>1.51,{2,8}=>3.01,{2,9}=>0,{2,10}=>0,{3,4}=>0,{3,5}=>1.5,{3,6}=>0,{3,7}=>0,{3,8}=>0,{3,9}=>1.01,{3,10}=>0,{4,5}=>0,{4,6}=>0,{4,7}=>0,{4,8}=>0,{4,9}=>0,{4,10}=>0,{5,6}=>0,{5,7}=>0,{5,8}=>0,{5,9}=>1.01,{5,10}=>0,{6,7}=>0,{6,8}=>0,{6,9}=>0,{6,10}=>0,{7,8}=>1.51,{7,9}=>0,{7,10}=>0,{8,9}=>0,{8,10}=>0,{9,10}=>0}
	end
